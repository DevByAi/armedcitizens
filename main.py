# ==================================
# קובץ: main.py (הגרסה המעודכנת ל-Webhooks + הוספת set_admin)
# ==================================
import os
import logging
import asyncio
...
def main():
    ...
    # תיקון שגיאת init_db(): הקריאה כבר תקינה עם DB_URL
    try:
        init_db(DB_URL)
    except Exception as e:
